          ...
          <div className="flex items-center space-x-3">
            ...
            {onClose && (
              <button
                id="header-close-btn"
                onClick={onClose}
                className="p-2 text-slate-400 hover:text-white hover:bg-slate-800 rounded-xl border border-slate-700/60 transition cursor-pointer bg-red-950/40 hover:bg-red-900/60 border-red-800/50"
